...
export class CodeMirrorEditor {
    ...
    constructor(options) {
        ...
        editor.on('paste', (instance, event) => {
            var _a;
            const handlePaste = (_a = this._config['handlePaste'], (_a !== null && _a !== void 0 ? _a : true));
            if (!handlePaste) {
    ...
    _onMimeTypeChanged() {
        ...
        void Mode.ensure(mime).then(spec => {
            var _a, _b;
            this.setOption('mode', (_b = (_a = spec) === null || _a === void 0 ? void 0 : _a.mime, (_b !== null && _b !== void 0 ? _b : 'null')));
        });
    }
    /**
