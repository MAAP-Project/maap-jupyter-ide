...
const extension = {
    ...
    activate: (app) => {
        app.restored.then(() => {
            ...
            ReactDOM.render(React.createElement(LabToastContainer, null), node);
            // For testing
            ...
            //   ]
            // });
            // let id2 = INotification.inProgress(
            //   "Task2 in progress! But how long will it take to get it done?"
            // );
