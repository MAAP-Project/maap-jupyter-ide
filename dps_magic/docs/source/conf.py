...
# -*- coding: utf-8 -*-
#
# dps_magic documentation build configuration file
#
...
_version_py = os.path.join(repo, 'dps_magic', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'dps_magicdoc'
...
latex_documents = [
    (master_doc, 'dps_magic.tex', 'dps_magic Documentation',
     'Elizabeth Yam', 'manual'),
]
