    ...
    def get(self):
        ...
        try:
            ...
            # if status !- 0, user workspace not already mounted
                ...
                mount_output = subprocess.check_output('s3fs -o iam_role=auto -o use_cache=/tmp/cache {} {}'.format(bucket,user_workspace), shell=True).decode('utf-8')
                ...
                mountdir_output = subprocess.check_output('s3fs -o iam_role=auto -o use_cache=/tmp/cache {} {}'.format(user_bucket_dir,user_workspace), shell=True).decode('utf-8')
